"""
Django settings for quiet_grass_40007 project.
...
ROOT_URLCONF = 'quiet_grass_40007.urls'
...
WSGI_APPLICATION = 'quiet_grass_40007.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_grass_40007 API",
    "DESCRIPTION": "API documentation for quiet_grass_40007 App",
    "VERSION": "v1",
}
